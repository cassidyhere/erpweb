  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="材料列表" prop="remark" class="head-item" style="margin-top:30px">
        <el-input v-model="mkey" placeholder="搜索材料" style="width: 200px;" class="filter-item" @keyup.enter.native="handleMaterialFilter" />
        <el-button class="filter-item" type="primary" icon="el-icon-search" @click="handleMaterialFilter">
          搜索
        </el-button>
      </el-form-item>
    </el-form>
