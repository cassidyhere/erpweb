<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="出仓单编号" prop="order_code" sortable="custom" min-width="140" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="出仓日期" sortable="custom" min-width="140" align="center">
        <template slot-scope="scope">
