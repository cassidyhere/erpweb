<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="退货单编号" prop="order_code" sortable="custom" min-width="100" align="left">
        <template slot-scope="scope">
      ...
      <el-table-column label="退货日期" sortable="custom" min-width="90" align="left">
        <template slot-scope="scope">
