<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="退库单编号" prop="order_code" sortable="custom" width="140" align="center">
        <template slot-scope="scope">
          {{ scope.row.order_code }}
        </template>
      </el-table-column>
      <el-table-column label="关联工程名称" prop="engineer_name" sortable="custom" width="150" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="info" @click="handleGetSlip(scope.row.id)">
            查看
          </el-button>
          ...
          <el-button
            ...
            type="success"
            plain
            @click="handleDownloadSlip(scope.row.id, scope.row.order_code)"
          >
            导出
          </el-button>
        </template>
